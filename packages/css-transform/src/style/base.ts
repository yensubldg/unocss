...
interface NestObject { [key: string]: string | string[] | NestObject }
...
export class Keyframes extends Style {
  ...
  static generate(name: string, children: Record<string, Record<string, string>>, root = undefined, prefixer = true): Keyframes[] {
